...
public class Status {
  ...
  public Status errorCode(String errorCode) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Error classification.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Error message describing the root cause of the error.")
