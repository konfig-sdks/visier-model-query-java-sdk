...
public class JSON {
...

    {
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.client.model.DocumentSearchLinkDTO.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.client.model.GoogleProtobufAny.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.client.model.SimpleDocumentHeaderSearchResponseDTO.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.client.model.SimpleDocumentHeaderSearchResultDTO.CustomTypeAdapterFactory());
